...
\begin{frame}{Completing once more: the field \(\C_p\)}
  ...
  complete, algebraically closed field, ready for analysis.
\end{frame}
...
\begin{frame}{Final picture}
  ...
  \smallskip
  The construction is the Cauchy completion of \(\Q\) a second time, with
  the \(p\)-adic size in place of the usual absolute value: one method,
  two different worlds of numbers.
\end{frame}
